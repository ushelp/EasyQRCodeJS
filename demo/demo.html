...
<script type="text/template" id="qrcodeTpl">
		...
		<script type="text/javascript">
			var demoParams = [
				...
				// All
				{
					title: "Title + SubTitle + Colorful - SVG",
					config: {
						text: "www.easyproject.cn/donation", // Content
