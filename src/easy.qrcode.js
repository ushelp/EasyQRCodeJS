        ...
        Drawing.prototype.draw = function (oQRCode) {
            ...
            function getLines(ctx, text, maxWidth) {
                ...
                for (var i = 1; i < words.length; i++) {
                    ...
                    if (width < maxWidth-maxWidth*0.05) {
                        currentLine += " " + word;
                    } else {
            ...
            function drawQrcode(oQRCode) {
                ...
                if (_htOption.title) {
                    ...
                    var lines = getLines(_oContext, _htOption.title, this._elCanvas.width);
                    for (var i = 0; i < lines.length; i++) {
						_oContext.fillText(lines[i], this._elCanvas.width / 2, +_htOption.quietZone + lineHeight);
						lineHeight += 30;
					}
                }
                ...
                if (_htOption.subTitle) {
                    ...
                    _oContext.fillText(_htOption.subTitle, this._elCanvas.width / 2, +_htOption.quietZone + lineHeight);
                }
