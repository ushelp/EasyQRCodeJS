...
(function() {
	...
	var Drawing = !_isSupportCanvas() ? (function() {
		...
		Drawing.prototype.draw = function(oQRCode) {
			...
			_oContext.clearRect(_htOption.quietZone, _htOption.quietZone, _htOption.width, _htOption
				.titleHeight);
			...
			function drawQrcode(oQRCode) {
				...
				if (_htOption.title) {
					...
					_oContext.fillRect(_htOption.quietZone, _htOption.quietZone, _htOption.width,
